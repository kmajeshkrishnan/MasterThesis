...
\begin{table}[htbp]
	...
	\caption[\textbf{\(AP_{box}\) and \(AP50_{box}\) for Training and Self-Training}]{\textbf{\(AP_{box}\) and \(AP50_{box}\) for Training and Self-Training} evaluated on COCO Eval dataset (Batch size 8) using baseline mask filtration for self-training}
